...
class HomeMobileDesktop extends StatefulWidget {
  BuildContext context;
  HomeMobileDesktop(BuildContext context) {
    this.context = context;
  }

  @override
  State<StatefulWidget> createState() => new HomeMobileDesktopState(context);
}

class HomeMobileDesktopState extends State<HomeMobileDesktop>
    with TickerProviderStateMixin {
  BuildContext context;

  HomeMobileDesktopState(BuildContext _context) {
...
//                                                      image: new AssetImage("assets/tablet/11.png")),
                                    ...
                                    Image(
                                        fit: BoxFit.fitWidth,
                                        width: MediaQuery.of(context).size.width,
                                        image: new AssetImage("assets/tablet/20.png")
